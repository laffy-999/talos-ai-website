  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Data we collect", "When you book a strategic session, Cal.eu collects the booking details and qualification answers you submit in the booking flow. This website itself does not store a separate lead form submission."],
        ...
        ["Processors", "Booking is handled by Cal.eu / EU-hosted Cal via the configured booking link. Hosting and infrastructure providers may process technical data required to operate the site."],
        ["Booking", "The booking calendar is embedded through Cal.eu, with an external Cal.eu booking link as fallback. This site does not prefill or transmit separate on-site form data to Cal.eu."],
  ...
  de: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Daten, die wir erheben", "Wenn du eine strategische Session buchst, erhebt Cal.eu die Buchungsdetails und Qualifizierungsantworten, die du im Booking-Flow eingibst. Diese Website speichert keine separate Lead-Formular-Anfrage."],
        ...
        ["Auftragsverarbeiter", "Buchungen werden über Cal.eu / EU-gehostetes Cal über den konfigurierten Booking-Link verarbeitet. Hosting- und Infrastruktur-Anbieter können technische Daten verarbeiten, die für den Betrieb der Website erforderlich sind."],
        ["Buchung", "Der Booking-Kalender ist über Cal.eu eingebettet, mit einem externen Cal.eu Booking-Link als Fallback. Diese Website füllt keine separaten Formular-Daten vorab aus und überträgt sie nicht an Cal.eu."],
  ...
  el: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Δεδομενα που συλλεγουμε", "Οταν κλεινεις strategic session, το Cal.eu συλλεγει τα booking details και qualification answers που υποβαλλεις στο booking flow. Το website δεν αποθηκευει ξεχωριστο lead form submission."],
        ...
        ["Εκτελουντες επεξεργασια", "Το booking γινεται με Cal.eu / EU-hosted Cal μεσω του configured booking link. Παροχοι hosting και infrastructure μπορει να επεξεργαζονται τεχνικα δεδομενα απαραιτητα για τη λειτουργια του site."],
        ["Booking", "Το booking calendar ειναι embedded μεσω Cal.eu, με external Cal.eu booking link ως fallback. Το site δεν κανει prefill και δεν μεταδιδει ξεχωριστα on-site form data στο Cal.eu."],
