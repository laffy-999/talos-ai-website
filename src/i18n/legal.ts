  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Booking", "The booking calendar is a Google-hosted page embedded in this site. It stays unloaded until you select the button that loads it, so visiting or reading the page transmits nothing to Google. Once you load it, your IP address, browser user agent, and the requested URL reach Google. You can also open the booking page in a new tab instead. This site does not prefill or transmit separate on-site form data to Google."],
        ["Cookies and analytics", "This site sets no cookies of its own. Traffic is measured with Cloudflare Web Analytics, which records page views, referrer, approximate country, browser, and page-performance metrics without setting cookies and without storing any identifier on your device. We also count three anonymous interactions on this site - opening the booking calendar and reaching the booking section - as totals only, without cookies and without storing any identifier or IP address. If you load the embedded Google booking calendar, Google sets its 'NID' cookie on the google.com domain, which Google uses for advertising and personalisation and which expires six months after last use. That cookie is set only once you ask for the calendar, never on an ordinary page view. To remove it, delete Google cookies in your browser."],
  ...
  de: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Buchung", "Der Buchungskalender ist eine von Google gehostete Seite, die in diese Website eingebettet ist. Er bleibt ungeladen, bis du die Schaltfläche zum Laden auswählst; das Besuchen und Lesen der Seite überträgt also nichts an Google. Sobald du ihn lädst, erreichen deine IP-Adresse, dein Browser-User-Agent und die aufgerufene URL Google. Du kannst die Buchungsseite stattdessen auch in einem neuen Tab öffnen. Diese Website füllt keine separaten Formulardaten vorab aus und überträgt sie nicht an Google."],
        ["Cookies und Analytics", "Diese Website setzt keine eigenen Cookies. Die Zugriffsmessung erfolgt mit Cloudflare Web Analytics, das Seitenaufrufe, Referrer, das ungefähre Land, den Browser und Performance-Metriken erfasst, ohne Cookies zu setzen und ohne eine Kennung auf deinem Gerät zu speichern. Zusätzlich zählen wir drei anonyme Interaktionen auf dieser Website - das Öffnen des Buchungskalenders und das Erreichen des Buchungsbereichs - ausschließlich als Summen, ohne Cookies und ohne Speicherung einer Kennung oder IP-Adresse. Wenn du den eingebetteten Google-Buchungskalender lädst, setzt Google sein Cookie 'NID' auf der Domain google.com, das Google für Werbung und Personalisierung nutzt und das sechs Monate nach der letzten Nutzung abläuft. Dieses Cookie wird erst gesetzt, wenn du den Kalender anforderst, nie bei einem normalen Seitenaufruf. Zum Entfernen lösche die Google-Cookies in deinem Browser."],
  ...
  el: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Booking", "Το booking calendar είναι σελίδα που φιλοξενεί η Google και είναι embedded σε αυτό το site. Παραμένει αφόρτωτο μέχρι να επιλέξεις το κουμπί που το φορτώνει, οπότε η επίσκεψη και η ανάγνωση της σελίδας δεν στέλνει τίποτα στην Google. Μόλις το φορτώσεις, φτάνουν στην Google η IP διεύθυνσή σου, ο user agent του browser και το URL που ζητήθηκε. Μπορείς επίσης να ανοίξεις τη σελίδα booking σε νέο tab. Το site δεν κάνει prefill και δεν μεταδίδει ξεχωριστά on-site form data στο Google."],
        ["Cookies και analytics", "Το site δεν βάζει δικά του cookies. Η μέτρηση επισκεψιμότητας γίνεται με το Cloudflare Web Analytics, που καταγράφει page views, referrer, κατά προσέγγιση χώρα, browser και μετρικές performance, χωρίς να βάζει cookies και χωρίς να αποθηκεύει κάποιο identifier στη συσκευή σου. Επιπλέον μετράμε τρεις ανώνυμες ενέργειες σε αυτό το site - το άνοιγμα του booking calendar και την προσέγγιση της ενότητας κράτησης - μόνο ως σύνολα, χωρίς cookies και χωρίς αποθήκευση αναγνωριστικού ή διεύθυνσης IP. Αν φορτώσεις το embedded booking calendar της Google, η Google βάζει το cookie 'NID' στο domain google.com, το οποίο χρησιμοποιεί για διαφήμιση και personalisation και λήγει έξι μήνες μετά την τελευταία χρήση. Το cookie αυτό μπαίνει μόνο όταν ζητήσεις το calendar, ποτέ σε μια απλή επίσκεψη στη σελίδα. Για να το αφαιρέσεις, σβήσε τα cookies της Google από τον browser σου."],
